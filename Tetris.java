...
public class Tetris extends Application {
    ...
    public static int XMAX = 500; // size of the playing area
    public static int YMAX = 900; // size of the playing area
    public static int PANE_WIDTH = 800;
    public static int PANE_HEIGHT = 900; // size of the pane
    public static int[][] MESH = new int[XMAX / SIZE][YMAX / SIZE];
    private static Pane group = new Pane();
    private static Form object;
    private static Scene scene = new Scene(group, PANE_WIDTH, PANE_HEIGHT, Color.BLACK); // ensure scene background color
    ...
    dialog.setTitle("Welcome to Tetris");
    ...
    private static class dialog {
        ...
        private static Object showAndWait() {
